...
public class NEATGenome extends BasicGenome implements Cloneable, Serializable {
	...
	private NEATGenome[] parents=null;
	private String name=null;
	
	public void setParents(NEATGenome[] parents) {
		this.parents=parents;
	}
	
	public void setPerformedOperationName(String name) {
		this.name=name;
	}
	
	public NEATGenome[] pollParents() {
		NEATGenome[] temp=parents;
		parents=null;
		return temp;
	}
	
	public String pollPerformedOperationName() {
		String temp=name;
		name=null;
		return temp;
	}
